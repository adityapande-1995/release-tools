...
[
  ...
  'edifice' : [
        ...
        'sdformat-ci-sdformat11-focal-amd64',
        'sdformat-ci-sdformat11-homebrew-amd64',
        'sdformat-ci-sdformat11-windows7-amd64',
        'sdformat-install-sdformat11_pkg-focal-amd64'
  ],
  'fortress' : [
        'ign_common-ign-4-win',
  ...
  steps {
    shell("""\
          ...
          for n in \${NIGHTLY_PACKAGES}; do
              ...
              python3 ./scripts/release.py \${dry_run_str} "\${n}" nightly "\${PASS}" --release-repo-branch main --nightly-src-branch \${src_branch} --upload-to-repo nightly || echo "MARK_AS_UNSTABLE"
              echo " - done"
          done
